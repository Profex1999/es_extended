...
ESX.CreatePickup = function(type, name, count, label, playerId, components, tint)
	...
	if type == 'item_weapon' then
		...
		ESX.Pickups[pickupId].tint  = tint
	end

	TriggerClientEvent('esx:createPickup', -1, pickupId, label, playerId, type, name, components, tint)
